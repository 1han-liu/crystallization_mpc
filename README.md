...
`docs/controller-reference-validation.md`. Run the complete Controller suite with:
...
`CONTROLLER_OPCUA_WRITE_ENABLED=false`, and the algorithm adapter enabled.
